...
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
...
<body>
	<h1>지역 게시판</h1>
	<div style="width: 600px; background-color: #ddd;">
		...
		<div>
			<div style="margin-left: 100px">
				<div style="border: 5px solid pink; width: 100px; height: 100px;">사진영역${dto.cbphoto}</div>
			</div>
		</div>
		<pre>
		...
		<br>
		<br>
		<br> <i class="bi bi-hand-thumbs-up"
			style="font-size: 40px; margin-left: 245px"></i> <i
		...
		<div style="margin: auto">
			<button type="submit" class="btn btn-sm btn-success updatebtn"
				style="margin-left: 225px" onclick="location.href='';">수정</button>
		...
		<form action="/action_page.php">
			<div class="mb-3 mt-3">
				<textarea class="form-control" rows="5" id="comment" name="text"
					style="height: 200px; resize: none; width: 500px; margin-left: 50px"
